//get restaurants from relais & chateau
    ...
    fetch(ele, {
      ...
      .then(function(value) {
        ...
        repHtml("h3.mainTitle2").each(function(i, element) {
          nameHotel = repHtml(this)
            .text()
            .trim();
        });

        repHtml("body > div.jsSecondNav.will-stick > ul.jsSecondNavSub").each(
          function(i, element) {
            var a = repHtml(this)
              .text()
              .trim();
        ...
        repHtml(
          "body > div.jsSecondNav.will-stick > ul.jsSecondNavMain > li:nth-child(2) > a"
